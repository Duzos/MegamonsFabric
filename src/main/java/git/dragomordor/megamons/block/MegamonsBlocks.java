...
//            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DIAMOND_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    ...
    public static final Block CRYSTAL_DAWN_STONE_ORE = registerBlock("crystal_dawn_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.DAWN_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_DUSK_STONE_ORE = registerBlock("crystal_dusk_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.DUSK_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_FIRE_STONE_ORE = registerBlock("crystal_fire_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.FIRE_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_ICE_STONE_ORE = registerBlock("crystal_ice_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.ICE_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_LEAF_STONE_ORE = registerBlock("crystal_leaf_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.LEAF_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_MOON_STONE_ORE = registerBlock("crystal_moon_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.MOON_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_SHINY_STONE_ORE = registerBlock("crystal_shiny_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.SHINY_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_SUN_STONE_ORE = registerBlock("crystal_sun_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.SUN_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_THUNDER_STONE_ORE = registerBlock("crystal_thunder_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.THUNDER_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));
    public static final Block CRYSTAL_WATER_STONE_ORE = registerBlock("crystal_water_stone_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(CobblemonBlocks.WATER_STONE_ORE).strength(5.5F,3.5F), UniformIntProvider.create(5,9)));


    // Megastone Geode Block
        // inner crystal block
    public static final Block ANISTARITE_GEODE_BLOCK = registerBlock("anistarite_geode_block",
            new Block(FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK).strength(5.5F,3.5F)));
        // outer shell block
