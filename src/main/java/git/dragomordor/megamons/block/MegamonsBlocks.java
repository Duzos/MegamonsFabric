...
//            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).strength(4.5F,3.0F), UniformIntProvider.create(5,9)));
...
//            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).strength(5.5F,3.5F).luminance((state) -> 8), UniformIntProvider.create(5,9)));
...
//            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).strength(5.5F,3.5F).luminance((state) -> 8), UniformIntProvider.create(5,9)));
    ...
    public static final Block ORE_CRYSTAL_AERODACTYLITE = registerBlock("aerodactylite_crystal_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    ...
    public static final Block CRYSTAL_DAWN_STONE_ORE = registerBlock("crystal_dawn_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.DAWN_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_DUSK_STONE_ORE = registerBlock("crystal_dusk_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.DUSK_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_FIRE_STONE_ORE = registerBlock("crystal_fire_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.FIRE_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_ICE_STONE_ORE = registerBlock("crystal_ice_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.ICE_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_LEAF_STONE_ORE = registerBlock("crystal_leaf_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.LEAF_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_MOON_STONE_ORE = registerBlock("crystal_moon_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.MOON_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_SHINY_STONE_ORE = registerBlock("crystal_shiny_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.SHINY_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_SUN_STONE_ORE = registerBlock("crystal_sun_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.SUN_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_THUNDER_STONE_ORE = registerBlock("crystal_thunder_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.THUNDER_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    public static final Block CRYSTAL_WATER_STONE_ORE = registerBlock("crystal_water_stone_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5,9), AbstractBlock.Settings.copy(CobblemonBlocks.WATER_STONE_ORE).strength(5.5F,3.5F).luminance((state) -> 8)));
    // Megastone Geode Block
        // inner crystal block
    public static final Block ANISTARITE_GEODE_BLOCK = registerBlock("anistarite_geode_block",
            new Block(AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).strength(5.5F,3.5F).luminance((state) -> 8)));
        // outer shell block
        public static final Block ANISTARITE_ROUGH_GEODE_BLOCK = registerBlock("anistarite_rough_geode_block",
                new Block(AbstractBlock.Settings.copy(Blocks.DEEPSLATE).strength(6.0F,4.0F).luminance((state) -> 4)));
