...
import git.dragomordor.megastones.item.list.MegastoneItemList;
import git.dragomordor.megastones.util.MegaEvolveMegastoneSpecies;
...
import static git.dragomordor.megastones.item.custom.MegaCuffItem.isInMegaStoneList;
import static git.dragomordor.megastones.util.MegastoneMegaSpecies.getPreSpeciesFromPostSpecies;
...
public class MegaDevolveEvent {
    ...
    private static void MegaDevolveCheck(Pokemon pokemon) {
        ...
        List<String> megaSpeciesString = MegastoneMegaSpecies.getMegaSpecies();
        ...
        if (megaSpeciesString.contains(pokemonSpeciesString)) {
            ...
            Species applicablePostEvolutionSpecies = MegaEvolveMegastoneSpecies.getApplicablePokemonPostEvolutionSpeciesFromMegastone(HeldItemItem);
