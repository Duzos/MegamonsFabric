...
import git.dragomordor.megastones.item.list.MegaPokemonList;
...
public class MegaCuffItem extends PokemonUseItem{
    ...
    public ActionResult processInteraction(ItemStack itemStack, PlayerEntity player, PokemonEntity target, Pokemon pokemon) throws NoPokemonStoreException {
        ...
        Species applicablePreEvolutionSpecies = MegaEvolveMegastoneSpecies.getApplicablePokemonPreEvolutionSpeciesFromMegastone(heldMegastone);
        Species applicablePostEvolutionSpecies = MegaEvolveMegastoneSpecies.getApplicablePokemonPostEvolutionSpeciesFromMegastone(heldMegastone);
